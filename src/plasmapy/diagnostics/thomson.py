...
try:
    # New unified dielectric module location (combined dielectric implementations).
    from plasmapy.formulary.dielectric_functions import permittivity_1D_Maxwellian_lite
except Exception:  # pragma: no cover
    # Fallback for older PlasmaPy layouts.
    from plasmapy.formulary import permittivity_1D_Maxwellian_lite
...
# =====================================================================
# Experimental extensions (folded in from thomson2.py)
#
# NOTE: The core PlasmaPy API above is intentionally unchanged.
# All functions imported from thomson2.py are exposed with the
# `_experimental` suffix to avoid namespace collisions.
# =====================================================================
...
def spectral_density_lite_experimental(
    wavelengths,
    probe_wavelength: _numbers.Real,
    n: _numbers.Real,
    T_e: np.ndarray,
    T_i: np.ndarray,
    efract: np.ndarray,
    ...
    probe_vec: np.ndarray,
    scatter_vec: np.ndarray,
    instr_func_arr: _Optional[np.ndarray] = None,
) -> tuple[_Union[np.floating, np.ndarray], np.ndarray]:
    r"""
    The :term:`lite-function` version of
...
def spectral_power_lite2_experimental(
    ...
    scatteringAngle: _numbers.Real,
    deltaAngle: _numbers.Real,
    angleStep: _numbers.Real,
    removeNotch: bool,
    notch_minimum: _numbers.Real,
    notch_maximum: _numbers.Real,
    instr_func_arr: _Optional[np.ndarray] = None,
) -> tuple[_Union[np.floating, np.ndarray], np.ndarray]:
    r"""
...
def spectral_density_experimental(  # noqa: C901, PLR0912, PLR0915
    ...
    *,
    ...
    probe_vec=None,
    scatter_vec=None,
    instr_func: _Optional[Callable] = None,
) -> tuple[_Union[np.floating, np.ndarray], np.ndarray]:
    r"""Calculate the spectral density function for Thomson scattering of
    a probe laser beam by a multi-species Maxwellian plasma.
