...
@preserve_signature
def spectral_density_lite_plasmapy(
    wavelengths,
    ...
    `~plasmapy.diagnostics.thomson.spectral_density_plasmapy`.  Performs the same
    thermal speed calculations as
    `~plasmapy.diagnostics.thomson.spectral_density_plasmapy`, but is intended
...
@bind_lite_func(spectral_density_lite_plasmapy)
def spectral_density_plasmapy(  # noqa: C901, PLR0912, PLR0915
    ...
    *,
    ...
    alpha, Skw = spectral_density_lite_plasmapy(
        wavelengths.to(u.m).value,
        probe_wavelength.to(u.m).value,
        n.to(u.m**-3).value,
        T_e.to(u.K).value,
...
# ***************************************************************************
# These functions are necessary to interface scalar Parameter objects with
# the array inputs of spectral_density_plasmapy
# ***************************************************************************


def _count_populations_in_params_plasmapy(params: dict[str, Any], prefix: str) -> int:
    """
...
def _params_to_array_plasmapy(
    ...
    if vector:
        npop = _count_populations_in_params_plasmapy(params, f"{prefix}_x")
        output = np.zeros([npop, 3])
        for i in range(npop):
            for j, ax in enumerate(["x", "y", "z"]):
        ...
        npop = _count_populations_in_params_plasmapy(params, prefix)
        output = np.zeros([npop])
        for i in range(npop):
...
def _spectral_density_model_plasmapy(wavelengths, settings=None, **params):
    """
    `lmfit` model function for fitting Thomson spectra.
    ...
    T_e = _params_to_array_plasmapy(params, "T_e")
    T_i = _params_to_array_plasmapy(params, "T_i")
    ion_mu = _params_to_array_plasmapy(params, "ion_mu")
    ion_z = _params_to_array_plasmapy(params, "ion_z")
    efract = _params_to_array_plasmapy(params, "efract")
    ifract = _params_to_array_plasmapy(params, "ifract")

    electron_speed = _params_to_array_plasmapy(params, "electron_speed")
    ion_speed = _params_to_array_plasmapy(params, "ion_speed")
    ...
    alpha, model_Skw = spectral_density_lite_plasmapy(
        wavelengths,
        probe_wavelength,
        n,
        T_e,
...
def spectral_density_model_plasmapy(  # noqa: C901, PLR0912, PLR0915
    ...
    num_e = _count_populations_in_params_plasmapy(params, "efract")
    num_i = _count_populations_in_params_plasmapy(params, "ifract")
    ...
    def _spectral_density_model_lambda(wavelengths, **params):
        return _spectral_density_model_plasmapy(wavelengths, settings=settings, **params)
...
def spectral_power_lite_experimental(
    wavelengths,
    probe_wavelength: numbers.Real,
    n: numbers.Real,
    T_e: np.ndarray,
    ...
    """ up until then, its the same as spectral_density_lite_experimental
...
def spectral_power_lite2_experimental(
    wavelengths,
    probe_wavelength: numbers.Real,
    n: numbers.Real,
    T_e: np.ndarray,
    ...
    if removeNotch == False and fNumberCorrection == False:
        alpha, Pkw = spectral_power_lite_experimental(
            wavelengths,
            probe_wavelength,
            n,
            T_e,
    ...
    if fNumberCorrection == True: # Iterate spectral_density_lite_experimental through
        ...
        for angle in angles:
            ...
            alpha_aux, Pkw_aux = spectral_power_lite_experimental(
                wavelengths,
                probe_wavelength,
                n,
                T_e,
...
@bind_lite_func(spectral_power_lite_experimental)
def spectral_power_experimental(  # noqa: C901, PLR0912, PLR0915
    wavelengths: u.nm,
    probe_wavelength: u.nm,
    n: u.m**-3,
    *,
    ...
    Legacy annotation from copying from spectral_density_lite_experimental:
    ...
    alpha, Skw = spectral_power_lite_experimental(
        wavelengths.to(u.m).value,
        probe_wavelength.to(u.m).value,
        n.to(u.m**-3).value,
        T_e.to(u.K).value,
...
def _count_populations_in_params_experimental(params: dict[str, Any], prefix: str) -> int:
    """
    Counts the number of electron or ion populations in a ``params``
    `dict`.
...
def _params_to_array_experimental(
    params: dict[str, Any], prefix: str, vector: bool = False
) -> np.ndarray:
    """
    Constructs an array from the values contained in the dictionary
    ...
    if vector:
        npop = _count_populations_in_params_experimental(params, f"{prefix}_x")
        output = np.zeros([npop, 3])
        for i in range(npop):
            for j, ax in enumerate(["x", "y", "z"]):
                output[i, j] = params[f"{prefix}_{ax}_{i}"].value
        ...
        npop = _count_populations_in_params_experimental(params, prefix)
        output = np.zeros([npop])
        for i in range(npop):
            output[i] = params[f"{prefix}_{i}"]
...
def _spectral_density_model_experimental(wavelengths, settings=None, **params):
    """
    lmfit Model function for fitting Thomson spectra.
    ...
    # LOAD FROM PARAMS
    n = params["n"]
    T_e = _params_to_array_experimental(params, "T_e")
    T_i = _params_to_array_experimental(params, "T_i")
    efract = _params_to_array_experimental(params, "efract")
    ifract = _params_to_array_experimental(params, "ifract")

    electron_speed = _params_to_array_experimental(params, "electron_speed")
    ion_speed = _params_to_array_experimental(params, "ion_speed")
    ...
    alpha, model_Skw = spectral_density_lite_experimental(
        # wavelengths,
        # probe_wavelength,
        # n,
        # T_e,
        ...
        #Correcting ion_mass - JGM 12/21/24
        wavelengths,
        probe_wavelength,
        n,
        T_e,
...
def _spectral_power_model_experimental(wavelengths, settings=None, **params):
    """
    lmfit Model function for fitting Thomson spectra.
    ...
    alpha, model_Pkw = spectral_power_lite_experimental(
        # wavelengths,
        # probe_wavelength,
        # n,
        # T_e,
...
def _spectral_power_model2_experimental(wavelengths, settings=None, **params):
    """
    lmfit Model function for fitting Thomson spectra.
    ...
    This version uses spectral_power_lite2_experimental which does 2 important
    things:
    ...
    alpha, model_Pkw = spectral_power_lite2_experimental(
        # wavelengths,
        # probe_wavelength,
        # n,
        # T_e,
        ...
        #Correcting ion mass - JGM 12/21/24
        wavelengths,
        probe_wavelength,
        n,
        T_e,
...
def spectral_density_model_experimental(  # noqa: C901, PLR0912, PLR0915
    ...
    num_e = _count_populations_in_params_experimental(params, "efract")
    num_i = _count_populations_in_params_experimental(params, "ifract")
    ...
    # Create and return the lmfit.Model
    return Model(
        _spectral_density_model_experimental,
        independent_vars=["wavelengths"],
        nan_policy="omit",
        settings=settings,
    )

def spectral_power_model_experimental(  # noqa: C901, PLR0912, PLR0915
    wavelengths, settings, params
):
    r"""
    Calculates the spectral power by correcting the spectral density function
    ...
    Legacy annotation from copying from spectral_density_model_experimental:
    ...
    # Create and return the lmfit.Model
    return Model(
        _spectral_power_model_experimental,
        independent_vars=["wavelengths"],
        nan_policy="omit",
        settings=settings,
    )
